...
var THEMES = [
  ...
  { id: 'spooky', name: 'Ghosts & a little spooky',
    blurb: 'Seasonal, made in small runs. When they are gone they are gone.' },
...
var DESIGNS = [
  ...
  {id:'bm-ghosts-reading', t:'bookmark', theme:'spooky', price:PRICE.acrylic, name:'Ghosts Reading', note:'Three little readers · black or gold tassel'},
  {id:'bm-ghost', t:'bookmark', theme:'spooky', price:PRICE.acrylic, name:'Little Ghost', note:'Die-cut, no tassel'},
  {id:'bm-bat', t:'bookmark', theme:'spooky', price:PRICE.acrylic, name:'Bat Wings', note:'Black die-cut corner bookmark'},
...
var SETS = [
  ...
  { id:'set-birthday', name:'Birthday Set', price: PRICE.card + PRICE.acrylic + 4,
    img:'assets/img/shop/cd-birthday-cake.jpg',
    items:['A birthday card', 'An acrylic bookmark', 'One beaded bracelet'],
    blurb:'Card, bookmark and a bracelet. Works as a present on its own.' },
